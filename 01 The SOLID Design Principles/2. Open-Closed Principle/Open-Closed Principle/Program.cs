...
namespace DotNetDesignPatternDemos.SOLID.OCP
{
	...
	public class AndSpecification<T> : ISpecification<T>
	{
		...
		public AndSpecification(ISpecification<T> first, ISpecification<T> second)
		{
			...
			if (second == null)
			{
				throw new ArgumentNullException(paramName: "second");
			}
			this.first = first;
			this.second = second;
		}
	...
	public class Demo
	{
		static void Main(string[] args)
		{
			...
			{
				Console.WriteLine(string.Format(" - {0} is large", p.Name));
			}
			...
			{
				Console.WriteLine(string.Format(" - {0} is large and blue", p.Name));
			}
		}
	}
}
